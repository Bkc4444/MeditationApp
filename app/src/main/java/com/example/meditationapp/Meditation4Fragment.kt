...
class Meditation4Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val playAndPauseBtn : Button = view.findViewById(R.id.startStopBtn4)
    ...
    private fun Meditation4Fragment.homeBtn(homeBtn: Button) {
    ...
    private fun playAndPause(playAndPauseBtn: Button) {
        playAndPauseBtn.setOnClickListener {
            if (!this::mediaPlayer.isInitialized) {
                mediaPlayer = MediaPlayer.create(requireContext(), R.raw.frustration)
            }
